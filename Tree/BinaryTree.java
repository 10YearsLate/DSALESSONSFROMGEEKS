...
A Binary Tree is a Tree where each node has two nodes.

Propertry:

1.It has a root node.
2.Every Node has value , a left child and a right child
3.TreeSet & Treemap are are java Libraries we have for Tree DS
